                ...
                UserModel.findOne({ email: req.body.email.toLowerCase()}, (err, userDetails) => {
                    ...
                    if (err) {
                        ...
                        /* prepare the message and the api response here */
                         mailMessages = {
                            email:req.body.email.toLowerCase(),
                            text:'Hey, you successfully login from "Meeting Planner"'
                        }
    ...
    let validatePassword = (retrievedUserDetails) => {
        ...
        return new Promise((resolve, reject) => {
            passwordLib.comparePassword(req.body.password, retrievedUserDetails.password, (err, isMatch) => {
                ...
                mailMessages.subject=(retrievedUserDetails.firstName)+', welcome  to your "Meeting Planner" '; //for sending  subject in mail 
                if (err) {
                    console.log(err)
...
let checkResetMail  = (data)  => {
    ...
    var mailOptions = {
        ...
        text: 'You are receiving this because you (or someone else) have requested the reset of the password for your account.\n\n' +
          ...
          'http://meetingplanner-frontend.testmanoj.com/reset/' + data.resetPasswordToken + '\n\n' +
